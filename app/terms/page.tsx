      ...
      <div className="wrap max-w-md">
        ...
        <div className="card card-pad">
          <div className="detail-block">
            <h2 className="tl-label text-base">Nature of this platform</h2>
          ...
          <div className="detail-block">
            <h2 className="tl-label text-base">Your responsibility</h2>
            <p className="muted-sm">
          ...
          <div className="detail-block">
            <h2 className="tl-label text-base">Full terms</h2>
            <p className="muted-sm">
