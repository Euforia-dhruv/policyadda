...
export const siteConfig: SiteConfig = {
  ...
  partners: [
    ...
    { name: "Kiwi General Insurance", logo: "/partners/kiwi.svg" },
    { name: "ICICI Lombard General Insurance", logo: "/partners/icici-lombard.png" },
    ...
    { name: "IndusInd Nippon General Insurance", logo: "/partners/indusind-nippon.svg" },
    { name: "Cholamandalam MS General Insurance", logo: "/partners/cholamandalam.svg" },
    { name: "Royal Sundaram General Insurance", logo: "/partners/royal-sundaram.png" },
    { name: "Generali Central Insurance", logo: "/partners/generali-central.svg" },
    { name: "Universal Sompo General Insurance", logo: "/partners/universal-sompo-wiki.svg" },
    { name: "Shriram General Insurance", logo: "/partners/shriram-general.jpg" },
    { name: "Magma HDI General Insurance", logo: "/partners/magma-hdi.png" },
    { name: "Navi General Insurance", logo: "/partners/navi.svg" },
    { name: "Raheja QBE General Insurance", logo: "/partners/raheja-qbe.png" },
  ],
  forms: {
